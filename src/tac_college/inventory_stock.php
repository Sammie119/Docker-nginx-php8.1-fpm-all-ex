                ...
                <div class="row justify-content-center round">
                    <div class="col-lg-10 col-md-12 ">
                        <div class="card shadow-lg card-1">
                            <form action="php/inventory_stock_sub.php" method="POST" name = "fees_form" id = "fees_form">
                            <div class="card-body inner-card" style="margin-top: 0%;">
                                <center><h4 style="font-size: 25px; color: #191970; font-family: Times new roman"><b>RE-STOCK INVENTORIES</b></h4></center>
                                <hr>

                                <div class="row justify-content-center" style="width: 70%; margin-left: 15%;">
                                    <div class="col-lg-5 col-md-6 col-sm-12">
                                        <div class="form-group"> <label for="pus_cell"></label> 
                                            <select name="item" id="item" class="form-control" style="height: 35px;" required>
                                                <option></option>
                                                <?php
                                                    $qry="SELECT item FROM items WHERE itemID <> '001'";
                                                        $i = 0;
                                    ...
                                    <div class="col-lg-5 col-md-6 col-sm-12">
                                        <div class="form-group"> <label for="red_cell"></label> 
                                            <input type="text" name="stock" class = "form-control" id="stock" readonly></div>
                                    </div>
                                </div>
                                <div class="row justify-content-center">
                                    <div class="col-md-12 col-lg-10 col-12" style="margin-left: 27%;">
                                        <div class="form-group"> <label for="lab_no">Re-Stock</label> 
                                            <input type="text" class = "form-control" id="re_stock" name="re_stock" class="form-control" style="width: 66.5%;"></div>
                                    </div>
                                </div>
