                ...
                <div class="row justify-content-center round">
                    <div class="col-lg-10 col-md-12 ">
                        <div class="card shadow-lg card-1">
                            <form action="enter_results.php" method="POST" name = "set_fees_form" id = "set_fees_form">
                            <div class="card-body inner-card" style="margin-top: 0%;">
                                <center><h4 style="font-size: 25px; color: #191970; font-family: Times new roman"><b>SELECT TO ENTER RESULTS</b></h4></center>
                                <hr>
                                ...
                                <div class="row justify-content-center" style="width: 70%; margin-left: 15%;">
                                    <div class="col-lg-5 col-md-6 col-sm-12">
                                        <div class="form-group"> <label for="epi_cell">Program</label> 
                                            <select name = "program" id="program" class="form-control" required style="height: 35px;">
                                              <option></option>
                                              <?php
                                    ...
                                    <div class="col-lg-5 col-md-6 col-sm-12">
                                        <div class="form-group"> <label for="epi_cell">Module</label> 
                                            <select name = "module" id="module" class="form-control" required style="height: 35px;">
                                              <option></option>
                                              <?php
                                                $qry_modules="SELECT modules FROM modules";
                                                      $i = 0;
                                    ...
                                    <div class="col-lg-5 col-md-6 col-sm-12">
                                        <div class="form-group"> <label for="epi_cell">Course</label> 
                                            <select name = "course" id="course" class="form-control" required style="height: 35px;">
                                              <option></option>
                                            </select></div>
                                    </div>
                                    <div class="col-lg-5 col-md-6 col-sm-12">
                                        <div class="form-group"> <label for="epi_cell">Year</label> 
                                            <select name="yr" class="form-control" required style="height: 35px;">
                                                <option></option>
                                                <?php 
