...
<script type="text/javascript">
    window.onload = function(){
      ...
      $('#module').on('change',function(){   
            ...
            $.post('php/get_course.php', module, processResposemodule);
        });

        function processResposemodule(data) {
            $("#course").empty();
        $("#course").html(data);
        };
                ...
                <div class="row justify-content-center round">
                    <div class="col-lg-10 col-md-12 ">
                        <div class="card shadow-lg card-1">
                            <form action="results.php" method="POST" name = "set_fees_form" id = "set_fees_form">
                            <div class="card-body inner-card" style="margin-top: 0%;">
                                <center><h4 style="font-size: 25px; color: #191970; font-family: Times new roman"><b>VIEW RESULTS</b></h4></center>
                                <hr>
                                <div class="row justify-content-center">
                                    <div class="col-md-12 col-lg-10 col-12" style="margin-left: 27%;">
                                        <div class="form-group"> <label for="lab_no">Program</label> 
                                            <select name = "program" id="program" class="form-control" style="height: 35px; width: 66.5%;" required>
                                              <option></option>
                                              <?php
                                                $qry="SELECT DISTINCT program FROM programs, results_episode WHERE results_episode.programID = programs.programID";
                                                      $i = 0;
                                ...
                                <div class="row justify-content-center" style="width: 70%; margin-left: 15%;">
                                    <div class="col-lg-5 col-md-6 col-sm-12">
                                        <div class="form-group"> <label for="pus_cell">Module</label> 
                                    ...
                                    <div class="col-lg-5 col-md-6 col-sm-12">
                                        <div class="form-group"> <label for="red_cell">Year</label> 
                                            <select name = "yr" id="yr" class="form-control" style="height: 35px;" required>
                                                <option></option>
                                                <?php 
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-md-12 col-lg-10 col-12" style="margin-left: 27%;">
                                        <div class="form-group"> <label for="lab_no">Course</label> 
                                            <select name = "course" id="course" class="form-control" style="height: 35px; width: 66.5%;" required>
                                              <option></option>
                                ...
                                <div class="row justify-content-center" style="width: 70%; margin-left: 15%; margin-top: 10px;">
                                    <div class="col-md-12 col-lg-10 col-12">
                                        <div class="row justify-content-end mb-5">
                                            <div class="col-lg-4 col-auto "><button type="submit" class="btn btn-primary btn-block"><small class="font-weight-bold"><i class="icofont-spinner"></i> Generate</small></button> </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
