...
<?php
    ...
    $module_yr = $module."/".$yr;
      ...
      $qry_pro="SELECT programID FROM programs WHERE program = '$program'";
        ...
        $qry_course="SELECT courseID FROM courses WHERE programID = '$programID' AND course = '$course'";
                                $i = 0;
...
<!--Start----->
            <div class="des_space" style="text-align: center; width: 98%; margin-left: 1%; margin-right: 1%;">
                <br>
                    <h4 style="font-size: 25px; color: #191970; font-family: Times new roman; font-weight: bold; text-transform: uppercase;">RESULTS FOR <?php echo $course." " .$module;?></h4>
                    <hr>
                    ...
                    <table border="0" align="center" width="100%">
                      ...
                      <?php
                                        ...
                                        $qry="SELECT student.index_no AS index_no, title, surname, fname, othername, quiz_1, quiz_2, exams, total FROM student, results_episode WHERE student.index_no = results_episode.index_no AND programID = '$programID' AND courseID = '$courseID' AND module_yr = '$module_yr' AND student.active = 'Yes' ORDER BY student.index_no ASC";
                                                $i = 1;
                      ...
                      <div style="text-align: center; width: 100%; padding-top: 20px;"><?php echo "<a href='php/print_results.php?courseID=$courseID&programID=$programID&module=$module_yr&course=$course&program=$program' class='btn btn-primary btn-block'><i class='icofont-print'></i> Print</a>";?></div>
            </div>
<!--End----->            
